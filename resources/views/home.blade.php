...
<section class="max-w-7xl mx-auto px-6 pt-10 pb-24">
    ...
    <div class="grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
            ...
            <a href="{{ route('competition') }}" class="bg-purple-600 hover:bg-purple-700 transition px-8 py-4 rounded-2xl font-semibold">
                Explore Now
            </a>
...
<section class="max-w-7xl mx-auto px-6 pb-24">
    ...
    <div class="flex items-center justify-between mb-12">
        ...
        <a href="{{ route('competition') }}" class="border border-white/10 hover:border-purple-500 transition px-5 py-3 rounded-xl">
            View All
        </a>
...
<section class="max-w-7xl mx-auto px-6 pb-32">
    ...
    <div class="relative overflow-hidden bg-gradient-to-r from-purple-700 to-fuchsia-600 rounded-[40px] p-12 text-center">
        ...
        <div class="relative">
            ...
            <a href="{{ route('competition') }}" class="bg-black text-white hover:bg-black/80 transition px-8 py-4 rounded-2xl font-semibold">
